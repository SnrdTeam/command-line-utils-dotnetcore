...
Имя опции (и короткое, и длинное) не должно совпадать с любым именем опции справки.

#### Вызов справки

Для вызова справки необходимо в командной строке указать путь до интересуещей команды и добавить опцию вывода справки '-h' или '--help'.
